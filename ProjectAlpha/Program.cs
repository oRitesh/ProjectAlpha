class Program
{
    ...
    static void CheckForMonster(Player player)
    {
        ...
        if (currentKills < 3)
        {
            monster.CurrentHitPoints = monster.MaximumDamage;
            return;
        }
    ...
    static void MovePlayer(Player player, string direction)
    {
        ...
        switch (direction)
        {
            case "N": newLocation = player.CurrentLocation.LocationToNorth; break;
            case "E": newLocation = player.CurrentLocation.LocationToEast; break;
            case "S": newLocation = player.CurrentLocation.LocationToSouth; break;
            case "W": newLocation = player.CurrentLocation.LocationToWest; break;
            default:
